...
public static class ExportLabels
{
    ...
    private static readonly Dictionary<string, (string Sr, string En)> Labels = new()
    {
        ...
        ["sheet.generalExpenses"] = ("Ostali troškovi", "Other expenses"),
        ...
        ["worked"] = ("Radno vrijeme", "Worked"),
        ["workType"] = ("Vrsta rada", "Work type"),
        ["status"] = ("Status", "Status"),
        ["note"] = ("Napomena", "Note"),
        ["hours"] = ("Sati", "Hours"),
        ["labourCost"] = ("Trošak rada", "Labour"),
        ["unpricedHours"] = ("Sati bez cijene", "Unpriced hours"),
        ...
        ["distance"] = ("Prijeđeno (km)", "Distance (km)"),
        ["serviceCost"] = ("Servis", "Service"),
        ["otherCost"] = ("Ostalo", "Other"),
        ["repairCost"] = ("Popravka", "Repair"),
        ["maintenanceCost"] = ("Održavanje", "Maintenance"),
        ["rentalCost"] = ("Zakup/lizing", "Rental/lease"),
        ["revenue"] = ("Prihod", "Revenue"),
        ["profit"] = ("Dobit", "Profit"),
        ["provider"] = ("Davalac", "Provider"),
        ["monthlyAmount"] = ("Mjesečni iznos", "Monthly amount"),
        ["odometer"] = ("Kilometraža", "Odometer"),
        ["kind"] = ("Vrsta", "Kind"),
        ["quantity"] = ("Količina", "Quantity"),
        ["unit"] = ("Jedinica", "Unit"),
        ["unitPrice"] = ("Cijena po jedinici", "Unit price"),
        ...
        ["assignedTo"] = ("Dodijeljeno", "Assigned to"),
        ["tool"] = ("Alat", "Tool"),
