...
/// Everything that is not "today": the links the home screen used to list, the
/// account, and the notices meant for administrators. Opened from the avatar.
      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            // The push notice is for whoever configures the server; a worker
            // cannot act on it.
            if (user.isAdminAndAbove) const _PushStatusNotice(),
            const SizedBox(height: 16),
            Card(
              child: ListTile(
