...
String enumLabel(AppLocalizations l10n, EnumKind kind, String? value) {
  ...
  final label = switch ((kind, value)) {
    ...
    (EnumKind.articleOrderStatus, 'Requested') => l10n.articleOrderStatusRequested,
    (EnumKind.articleOrderStatus, 'Ordered') => l10n.articleOrderStatusOrdered,
    (EnumKind.articleOrderStatus, 'InDelivery') => l10n.articleOrderStatusInDelivery,
    (EnumKind.articleOrderStatus, 'Delivered') => l10n.articleOrderStatusDelivered,
    (EnumKind.articleOrderStatus, 'Rejected') => l10n.articleOrderStatusRejected,
    (EnumKind.articleOrderStatus, 'Cancelled') => l10n.articleOrderStatusCancelled,
    (EnumKind.refundStatus, 'Requested') => l10n.refundStatusRequested,
    (EnumKind.refundStatus, 'Approved') => l10n.refundStatusApproved,
    (EnumKind.refundStatus, 'Rejected') => l10n.refundStatusRejected,
    (EnumKind.refundStatus, 'Cancelled') => l10n.refundStatusCancelled,
