...
public class AttachmentRetentionReminderConfiguration : IEntityTypeConfiguration<AttachmentRetentionReminder>
{
    public void Configure(EntityTypeBuilder<AttachmentRetentionReminder> builder)
    {
        builder.ToTable("attachment_retention_reminders");
