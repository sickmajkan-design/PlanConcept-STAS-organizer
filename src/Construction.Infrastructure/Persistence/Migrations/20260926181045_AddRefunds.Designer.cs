...
namespace Construction.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260926181045_AddRefunds")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Construction.Domain.Entities.Absence", b =>
                {
                    ...
                    b.Property<bool>("ProposedByEmployee")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("absences", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_absences_proposed_ends_after_start", "\"ProposedEndDate\" IS NULL OR \"ProposedEndDate\" >= \"ProposedStartDate\"");
                        });
                });
            ...
            modelBuilder.Entity("Construction.Domain.Entities.Accommodation", b =>
                {
                    ...
                    b.Property<DateOnly?>("ContractExpiryNotifiedFor")
                        .HasColumnType("date");
                    ...
                    b.ToTable("accommodations", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_accommodations_contract_ends_after_start", "\"ContractEnd\" IS NULL OR \"ContractStart\" IS NULL OR \"ContractEnd\" >= \"ContractStart\"");
            ...
            modelBuilder.Entity("Construction.Domain.Entities.AccommodationRate", b =>
                {
                    ...
                    b.HasIndex("AccommodationId", "StartDate");

                    b.ToTable("accommodation_rates", null, t =>
                        {
                            t.HasCheckConstraint("ck_accommodation_rates_ends_after_start", "\"EndDate\" IS NULL OR \"EndDate\" >= \"StartDate\"");

                            t.HasCheckConstraint("ck_accommodation_rates_positive", "\"Amount\" > 0");
                        });
                });

            modelBuilder.Entity("Construction.Domain.Entities.AccommodationStay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("accommodation_stays", null, t =>
                        {
                            t.HasCheckConstraint("ck_accommodation_stays_ends_after_start", "\"EndDate\" IS NULL OR \"EndDate\" >= \"StartDate\"");
                        });
                });
            ...
            modelBuilder.Entity("Construction.Domain.Entities.ArticleOrder", b =>
                {
                    ...
                    b.ToTable("article_orders", (string)null);
                });

            modelBuilder.Entity("Construction.Domain.Entities.ArticleOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("ArticleOrderId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ArticleOrderId");

                    b.ToTable("article_order_items", null, t =>
                        {
                            t.HasCheckConstraint("ck_article_order_items_quantity", "\"Quantity\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("Construction.Domain.Entities.Attachment", b =>
                {
                    ...
                    b.Property<Guid?>("AccommodationRateId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("EmployeeRateId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("GeneralExpenseId")
                        .HasColumnType("uuid");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("boolean");

                    b.Property<Guid?>("MaterialMovementId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("VehicleRentalRateId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("FinanceEntryId");

                    b.HasIndex("GeneralExpenseId");

                    b.HasIndex("MaterialMovementId");
                    ...
                    b.HasIndex("VehicleRentalRateId");
            ...
            modelBuilder.Entity("Construction.Domain.Entities.BulletinView", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("BulletinPostId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BulletinPostId", "UserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Construction.Domain.Entities.EmployeeRate", b =>
                {
                    ...
                    b.ToTable("employee_rates", null, t =>
                        {
                            t.HasCheckConstraint("ck_employee_rates_daily_positive", "\"DailyRate\" IS NULL OR \"DailyRate\" > 0");
                            ...
                            t.HasCheckConstraint("ck_employee_rates_weekend_positive", "\"WeekendHourlyRate\" IS NULL OR \"WeekendHourlyRate\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("Construction.Domain.Entities.GeneralExpense", b =>
                {
                    ...
                    b.ToTable("general_expenses", null, t =>
                        {
                            t.HasCheckConstraint("ck_general_expenses_amount_not_negative", "\"Amount\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("Construction.Domain.Entities.LedgerCell", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ledger_cells", (string)null);
                });

            modelBuilder.Entity("Construction.Domain.Entities.LedgerColumn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ledger_columns", (string)null);
                });
            ...
            modelBuilder.Entity("Construction.Domain.Entities.LedgerRow", b =>
                {
                    ...
                    b.ToTable("ledger_rows", (string)null);
                });
            ...
            modelBuilder.Entity("Construction.Domain.Entities.Material", b =>
                {
                    ...
                    b.ToTable("materials", null, t =>
                        {
                            t.HasCheckConstraint("ck_materials_minimum_not_negative", "\"MinimumQuantity\" IS NULL OR \"MinimumQuantity\" >= 0");

                            t.HasCheckConstraint("ck_materials_price_not_negative", "\"UnitPrice\" IS NULL OR \"UnitPrice\" >= 0");
            ...
            modelBuilder.Entity("Construction.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<string>("BudgetAlertBasis")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<int?>("BudgetWarnPercent")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("projects", null, t =>
                        {
                            t.HasCheckConstraint("ck_projects_budget_not_negative", "\"Budget\" IS NULL OR \"Budget\" >= 0");

                            t.HasCheckConstraint("ck_projects_budget_warn_percent_range", "\"BudgetWarnPercent\" IS NULL OR (\"BudgetWarnPercent\" >= 1 AND \"BudgetWarnPercent\" <= 99)");

                            t.HasCheckConstraint("ck_projects_contract_value_not_negative", "\"ContractValue\" IS NULL OR \"ContractValue\" >= 0");
                        });
                });

            modelBuilder.Entity("Construction.Domain.Entities.ProjectRevenue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("project_revenues", null, t =>
                        {
                            t.HasCheckConstraint("ck_project_revenues_amount_not_negative", "\"Amount\" >= 0");
                        });
                });

            modelBuilder.Entity("Construction.Domain.Entities.PublicHoliday", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Construction.Domain.Entities.Refund", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("refunds", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_refunds_payroll_month", "\"PayrollMonth\" IS NULL OR \"PayrollMonth\" BETWEEN 1 AND 12");
                        });
                });
            ...
            modelBuilder.Entity("Construction.Domain.Entities.ToolExpense", b =>
                {
                    ...
                    b.HasIndex("ToolId", "OccurredOn");

                    b.ToTable("tool_expenses", null, t =>
                        {
                            t.HasCheckConstraint("ck_tool_expenses_amount_not_negative", "\"Amount\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("Construction.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<int?>("DocumentExpiryReminderDays")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("users", null, t =>
                        {
                            t.HasCheckConstraint("ck_users_reminder_days_positive", "\"DocumentExpiryReminderDays\" IS NULL OR \"DocumentExpiryReminderDays\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("Construction.Domain.Entities.VehicleRentalRate", b =>
                {
                    ...
                    b.ToTable("vehicle_rental_rates", null, t =>
                        {
                            t.HasCheckConstraint("ck_vehicle_rental_rates_ends_after_start", "\"EndDate\" IS NULL OR \"EndDate\" >= \"StartDate\"");
            ...
            modelBuilder.Entity("Construction.Domain.Entities.Absence", b =>
                {
                    ...
                    b.HasOne("Construction.Domain.Entities.User", "ProposedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Construction.Domain.Entities.ArticleOrder", b =>
                {
                    ...
                    b.HasOne("Construction.Domain.Entities.User", "HandledByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Construction.Domain.Entities.ArticleOrderItem", b =>
                {
                    b.HasOne("Construction.Domain.Entities.ArticleOrder", "ArticleOrder")
                        .WithMany("Items")
                        .HasForeignKey("ArticleOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ArticleOrder");
                });
            ...
            modelBuilder.Entity("Construction.Domain.Entities.Attachment", b =>
                {
                    ...
                    b.HasOne("Construction.Domain.Entities.AccommodationRate", "AccommodationRate")
                        .WithMany()
                    ...
                    b.HasOne("Construction.Domain.Entities.EmployeeRate", "EmployeeRate")
                        .WithMany()
                        .HasForeignKey("EmployeeRateId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Construction.Domain.Entities.FinanceEntry", "FinanceEntry")
                        .WithMany()
                        .HasForeignKey("FinanceEntryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Construction.Domain.Entities.GeneralExpense", "GeneralExpense")
                        .WithMany()
                        .HasForeignKey("GeneralExpenseId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Construction.Domain.Entities.MaterialMovement", "MaterialMovement")
                        .WithMany()
                        .HasForeignKey("MaterialMovementId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("Construction.Domain.Entities.Refund", "Refund")
                        .WithMany()
                        .HasForeignKey("RefundId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Construction.Domain.Entities.ToolExpense", "ToolExpense")
                        .WithMany()
                        .HasForeignKey("ToolExpenseId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("Construction.Domain.Entities.VehicleRentalRate", "VehicleRentalRate")
                        .WithMany()
                        .HasForeignKey("VehicleRentalRateId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.Navigation("AccommodationRate");
                    ...
                    b.Navigation("VehicleRentalRate");
            ...
            modelBuilder.Entity("Construction.Domain.Entities.BulletinView", b =>
                {
                    b.HasOne("Construction.Domain.Entities.BulletinPost", "BulletinPost")
                        .WithMany("Views")
            ...
            modelBuilder.Entity("Construction.Domain.Entities.LedgerCell", b =>
                {
                    b.HasOne("Construction.Domain.Entities.LedgerColumn", "Column")
                        .WithMany()
                        .HasForeignKey("ColumnId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Construction.Domain.Entities.LedgerRow", "Row")
                        .WithMany("Cells")
                        .HasForeignKey("RowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Construction.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasOne("Construction.Domain.Entities.Project", "ParentProject")
